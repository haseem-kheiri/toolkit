 ...
 *
 * <p>This class provides predefined role instances for the three standard message types used in AI
 * conversations. Each role instance encapsulates both a type-safe object reference and its
 * corresponding string value for serialization.
 *
 ...
 * </ul>
 *
 * <p><strong>Usage:</strong> Use the static instances ({@code Role.SYSTEM}, {@code Role.USER},
 * {@code Role.ASSISTANT}) rather than creating new instances. These provide both type safety in
 * Java code and the correct object structure for JSON serialization with the value accessible via
 * {@link #value()}.
 *
...
public final class Role {
   ...
   *
   * <p><strong>Note:</strong> In most cases, you should use the predefined static instances ({@link
   * #SYSTEM}, {@link #USER}, {@link #ASSISTANT}) rather than creating new Role objects. This
   * constructor is provided for extensibility and custom role types if needed.
   *
